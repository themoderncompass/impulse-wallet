...
// impulse-api/events.js
var up = /* @__PURE__ */ __name((s) => (s || "").trim().toUpperCase(), "up");
...
// impulse-api/focus.js
var up2 = /* @__PURE__ */ __name((s) => (s || "").trim().toUpperCase(), "up");
...
async function ensureFocusShape(env) {
  ...
  const add = /* @__PURE__ */ __name(async (name, ddl) => {
...
async function onRequestPost3({ request, env }) {
  try {
    ...
    `).run();
    const addColumn = /* @__PURE__ */ __name(async (column, definition) => {
      try {
...
async function ensureSchema(env) {
  ...
  `).run();
  const addColumnIfNotExists = /* @__PURE__ */ __name(async (column, definition) => {
    try {
      await env.DB.prepare(`ALTER TABLE rooms ADD COLUMN ${column} ${definition}`).run();
    } catch (e) {
    }
...
// impulse-api/room-leave.js
var up3 = /* @__PURE__ */ __name((s) => (s || "").trim().toUpperCase(), "up");
...
__name(ensurePlayersShape2, "ensurePlayersShape");
...
// impulse-api/room-manage.js
var up4 = /* @__PURE__ */ __name((s) => (s || "").trim().toUpperCase(), "up");
...
// impulse-api/room-suggestions.js
var up5 = /* @__PURE__ */ __name((s) => (s || "").trim().toUpperCase(), "up");
...
// impulse-api/state.js
var up6 = /* @__PURE__ */ __name((s) => (s || "").trim().toUpperCase(), "up");
...
__name(ensurePlayersShape3, "ensurePlayersShape");
...
__name(requireMember2, "requireMember");
...
// ../.wrangler/tmp/pages-yKdVed/functionsRoutes-0.7173821348128027.mjs
var routes = [
  {
...
//# sourceMappingURL=functionsWorker-0.42732680892103736.mjs.map
